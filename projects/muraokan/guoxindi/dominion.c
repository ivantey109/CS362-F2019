...
int baron_effect(int choice1, int currentPlayer, int handPos, struct gameState *state){
...
int minion_effect(int choice1, int choice2, int currentPlayer, int handPos, struct gameState *state){
  //+1 action
  // this line has changed for AS5
  state->numActions++;
...
int ambassador_effect(int choice1, int choice2, int currentPlayer, int handPos, struct gameState *state){
  ...
  // bugs, the counter i has not incremented inside of for loop
...
int tribute_effect(struct gameState *state, int currentPlayer, int nextPlayer, int *tributeRevealedCards){
...
int mine_effect(int choice1, int choice2, int currentPlayer, int handPos, struct gameState *state){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        mine_effect(choice1, choice2, currentPlayer, handPos, state);
    ...
    case baron:
        baron_effect(choice1, currentPlayer, handPos, state);
    ...
    case minion:
        minion_effect(choice1, choice2, currentPlayer, handPos, state);
    ...
    case tribute:
        tribute_effect(state, currentPlayer, nextPlayer, tributeRevealedCards);

    case ambassador:
        ambassador_effect(choice1, choice2, currentPlayer, handPos, state);

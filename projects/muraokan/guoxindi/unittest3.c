...
// Unit Test function for Ambassadar card effect
int main(){
    ...
    for(i=0; i<1000; i++){ // the number of tests to run
        ...
        if(choice2 > 2){
            printf("ERROR: Choice2 cannot be more than 2");
        }
        ...
        supplyCountBefore = state->supplyCount[state->hand[currentPlayer][choice1]];
            ...
            // if supply count has not correctly added
            if(supplyCountAfter != supplyCountBefore + choice2){ 

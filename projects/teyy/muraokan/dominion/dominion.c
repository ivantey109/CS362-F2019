...
// Returns the cost of the card which passed to this functions
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
    ...
    case mine:
        ...
        errorHundlingForMine(j, choice2, state);
        // Bug, discardCard function should come at first and gainCard come after that 
